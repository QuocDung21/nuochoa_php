...
while ($item = mysqli_fetch_array($query_category_edit)) {
    ?>
    <form method="POST"
          action="modules/category/xuly.php?category_id=<?php echo $_GET['category_id'] ?>"
                        ...
                        <div class="card-content">
                            ...
                            <div class="input-item form-group">
                                ...
                                <input type="text" name="category_name" class="form-control"
                                       value="<?php echo $item['category_name'] ?>" placeholder="collection name">
                            </div>
                            <div class="input-item form-group">
                                <label for="title" class="d-block">Mô tả danh mục</label>
                                <textarea class="form-control" name="category_description" type="text" value=""
                                          placeholder="collection name"
                                          style="height: auto;"><?php echo $item['category_description'] ?></textarea>
                            </div>
                                ...
                                <div class="input-item form-group">
                                    ...
                                    <div class="image-box w-100">
                                        <figure class="image-container p-relative">
                                            <img src="modules/category/uploads/<?php echo $item['category_image'] ?>"
                                                 id="chosen-image">
