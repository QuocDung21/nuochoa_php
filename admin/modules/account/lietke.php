...
if (isset($_POST['account_keyword'])) {
    ...
    $sql_account_list = "SELECT * FROM account, customer where account.account_id = customer.account_id AND account.account_type != 2  ORDER BY account_type DESC";
    $query_account_list = mysqli_query($mysqli, $sql_account_list);
}
                    ...
                    <div class="main-pane-top d-flex justify-center align-center">
                        <div class="input__search p-relative">
                            <form class="search-form" action="" method="POST">
                                ...
                                <input type="search" class="form-control" name="account_keyword"
